  ...
  try {
    ...
    const sessionConfig: any = {
      ...
      metadata: {
        ...
        originalAmount: String(planData?.pricing?.basePrice || planData?.price || 0),
        discountAmount: String(planData?.pricing?.discount || 0),
        finalAmount: String(planData?.pricing?.finalAmount || planData?.price || 0),
